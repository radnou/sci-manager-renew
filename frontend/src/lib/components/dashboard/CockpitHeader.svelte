				...
				<div class="flex flex-wrap items-start justify-between gap-4">
					<div class="space-y-3">
						...
						<div class="flex flex-wrap items-center gap-2">
							<span
								class={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${statusClass(activeSciProfile?.statut)}`}
							>
						...
						<p class="max-w-2xl text-sm leading-relaxed text-slate-600 dark:text-slate-300">
							{#if activeSciProfile}
								Lecture d'exécution de la SCI sélectionnée: identité, gouvernance, encaissements et
