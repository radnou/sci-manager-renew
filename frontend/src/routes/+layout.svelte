...
>
	...
	>
			...
			<div class="flex items-center gap-6">
				...
				{#if user}
					...
					<div class="flex items-center gap-3">
						<span class="hidden text-sm text-slate-600 sm:inline dark:text-slate-400">
							{user.email}
						</span>
		...
		{#if user}
			<div class="border-t border-slate-200 md:hidden dark:border-slate-800">
				<div class="flex items-center justify-around px-4 py-2">
					<a
						href="/dashboard"
						class="flex flex-col items-center gap-1 text-xs text-slate-600 transition-colors hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100"
					>
						<span>Dashboard</span>
					</a>
					<a
