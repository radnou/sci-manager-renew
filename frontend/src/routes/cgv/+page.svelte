				...
				<table class="w-full text-sm">
					<thead>
						<tr class="border-b border-slate-200 dark:border-slate-700">
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">Plan</th>
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">Prix HT</th>
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">TVA (20%)</th>
							<th class="py-2 text-left font-semibold text-slate-900 dark:text-slate-100">Prix TTC</th>
						</tr>
					</thead>
			...
			<div class="mt-2 overflow-x-auto">
				<table class="w-full text-sm">
					<thead>
						<tr class="border-b border-slate-200 dark:border-slate-700">
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">Plan</th>
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">Prix HT/an</th>
							<th class="py-2 pr-4 text-left font-semibold text-slate-900 dark:text-slate-100">TVA (20%)</th>
							<th class="py-2 text-left font-semibold text-slate-900 dark:text-slate-100">Prix TTC/an</th>
						</tr>
					</thead>
					<tbody class="divide-y divide-slate-100 dark:divide-slate-800">
						<tr>
