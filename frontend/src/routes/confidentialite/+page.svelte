				...
				<table class="w-full text-sm">
					...
					<tbody class="divide-y divide-slate-100 dark:divide-slate-800">
						...
						<tr>
							...
							<td class="py-2 pr-4">Gestion des paiements</td>
							<td class="py-2">UE / US (clauses contractuelles types)</td>
						</tr>
						<tr>
							<td class="py-2 pr-4">Resend</td>
							<td class="py-2 pr-4">Envoi d'emails transactionnels</td>
							<td class="py-2">US (clauses contractuelles types)</td>
						</tr>
						<tr>
